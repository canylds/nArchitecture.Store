...
public class UpdateUserOperationClaimCommand : IRequest<UpdatedUserOperationClaimResponse>, ISecuredRequest
{
    ...
    public string[] Roles => [Admin, Write, UserOperationClaimsOperationClaims.Update];

    public UpdateUserOperationClaimCommand()
    {

    }

    public UpdateUserOperationClaimCommand(int id, int userId, int operationClaimId)
    {
        Id = id;
        UserId = userId;
    ...
    public class UpdateUserOperationClaimCommandHandler : IRequestHandler<UpdateUserOperationClaimCommand, UpdatedUserOperationClaimResponse>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _userOperationClaimBusinessRules.UserShouldNotHasOperationClaimAlreadyWhenUpdated(request.Id,
            request.UserId,
            ...
            await _userOperationClaimRepository.UpdateAsync(mappedUserOperationClaim, cancellationToken);
