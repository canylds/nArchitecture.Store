...
public class DeleteOperationClaimCommand : IRequest<DeletedOperationClaimResponse>, ISecuredRequest
{
    ...
    public string[] Roles => [Admin, Write, OperationClaimsOperationClaims.Delete];

    public DeleteOperationClaimCommand()
    {

    }

    public DeleteOperationClaimCommand(int id)
    {
        Id = id;
    }
    ...
    public class DeleteOperationClaimCommandHandler : IRequestHandler<DeleteOperationClaimCommand, DeletedOperationClaimResponse>
    {
        ...
        CancellationToken cancellationToken)
        {
            ...
            await _operationClaimRepository.DeleteAsync(entity: operationClaim!, cancellationToken: cancellationToken);
